...
function importTrieRx(lines) {
    ...
    const r = lines.pipe(operators_1.tap(headerLines), operators_1.map(a => a.replace('\n', '')), operators_1.skipWhile(line => line !== '*'), operators_1.filter(a => !!a), operators_1.reduce((acc, line) => {

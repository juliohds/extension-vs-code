...
var es7_shim_1 = require("es7-shim");
...
function JsonToTS(json, userOptions) {
    ...
    return get_interfaces_1.getInterfaceDescriptions(typeStructure, names)
        .map(get_interfaces_1.getInterfaceStringFromDescription);
}
